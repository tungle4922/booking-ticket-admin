...
const SignIn: React.FC = () => {
  ...
  const login = async () => {
    const res = await userService.login(form.getFieldsValue());
    if (res?.token) {
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <p className="2xl:px-20">Trang quản trị website Booking Ticket</p>
              ...
              >
                  ...
                  <div className="relative">
                    <Form.Item name="email">
                      <input
                        ...
                        className="w-[600px] rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      />
                    </Form.Item>
                  </div>
                </div>
                ...
                <div className="mb-5">
                  <Form.Item>
                    <Button
                      onClick={login}
                      className="!bg-blue-600 !w-[600px] h-12"
                      type="primary"
                      htmlType="submit"
                    >
                      Đăng nhập
